...
Route::get('/slander_victim/{num?}', 'App\Http\Controllers\SlanderController@getVictimSlander');
Route::get('/slander_victim_all/{time?}/{num?}/{page?}', 'App\Http\Controllers\SlanderController@getVictimSlander_all');
...
Route::get('/lawyer_comment_search/{id?}/{search?}', 'App\Http\Controllers\LawyerCommentController@searchLawyerComment');
